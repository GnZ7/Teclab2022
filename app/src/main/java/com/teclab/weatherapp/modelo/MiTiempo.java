package com.teclab.weatherapp.modelo;
...
public class MiTiempo implements Serializable {
  ...
  public List<? extends Weather> getWeather() {
    return this.weather;
  }

  public void setWeather(List<? extends Weather> weather) {
  ...
  public static class Sys implements Serializable {
    ...
    public String getSunset() {
      ...
      dateSunset.setTime((long)sunset*1000);
  ...
  public static class Weather implements Serializable {
    ...
    public String getDescription() {
      String status = description.substring(0, 1).toUpperCase() + description.substring(1, description.length());
      return status;
    }
